...
def central_corridor()
  ...
  puts "your entire crew. You are the last one surviving and your last"
  ...
  if action.include? "shoot"
    ...
    puts "off your aim. You laser hits his costume but misses his entirely. This"
    puts "completely ruins his brand new costume that his mother bought him, which"
    ...
    puts "You tell that one Gothon joke you know:"
    puts "Lbhe zbgure vf fb sng, jura fur fvgf nebhaq gur ubhfr, fur fvgf nebhaq gur ubhfr."
    puts "The Gothon stops, trying not to laugh, then busts out laughing and can't move."
    puts "While he is laughing you run up and shoot him square in the head"
...
def laser_weapon_armory()
  ...
  puts "neutron bomb in it's container. There's keypad lock on the box"
